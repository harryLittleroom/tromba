...
/**
 The base class for all tromba modules
 */
...
/**
 tromba Platform calls this method on startup.
 */
-(void)startup;

/**
 tromba Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 tromba Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 tromba Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 tromba Platform calls this method on resume.
 @param sender The sender of the event.
 */
