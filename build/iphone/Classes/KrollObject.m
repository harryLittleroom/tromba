 ...
 * Copyright (c) 2009-2011 by tromba, Inc. All Rights Reserved.
...
//@interface trombaObject : NSObject
//@end

@interface trombaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[trombaObject class]])
		{
			for (NSString *key in [[(trombaObject*)o modules] allKeys])
			{
