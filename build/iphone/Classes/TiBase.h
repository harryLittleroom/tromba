...
// in simulator we redefine to format for tromba Developer console
...
{\
	NSString * exceptionName = [@"org.tromba." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tromba";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItrombaNativeItemNone = -1, 
	UItrombaNativeItemSpinner = -2,
	UItrombaNativeItemProgressBar = -3,
	
	UItrombaNativeItemSlider = -4,
	UItrombaNativeItemSwitch = -5,
	UItrombaNativeItemMultiButton = -6,
	UItrombaNativeItemSegmented = -7,
	
	UItrombaNativeItemTextView = -8,
	UItrombaNativeItemTextField = -9,
	UItrombaNativeItemSearchBar = -10,
	
	UItrombaNativeItemPicker = -11,
	UItrombaNativeItemDatePicker = -12,
	
	UItrombaNativeItemInfoLight = -13,
	UItrombaNativeItemInfoDark = -14,
	
	UItrombaNativeItemDisclosure = -15,
	
	UItrombaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all tromba instances of
