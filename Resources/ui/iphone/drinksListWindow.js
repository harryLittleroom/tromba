...
function drinksListWindow(navigroup, category) {
	var data = Data.readTrombData('drinks');
	var self = new commonWindow();
	var titleView = addTitleBar('Recipes: Toronto Handbook', self);
	...
	scrollView.top= titleView.height;
	var fontsize = 14;
	...
	for (var i = 0; i < data.length; i++) {
		...
		if(data[i].category==category)createview();
	};
